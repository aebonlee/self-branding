  ...
  menuItems: [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { path: '/lessons/midterm', labelKey: 'site.nav.week8' },
        { path: '/lessons/corporate-pr', labelKey: 'site.nav.week9' },
        { path: '/lessons/personal-branding', labelKey: 'site.nav.week10' },
        { path: '/lessons/portfolio-branding', labelKey: 'site.nav.week11' },
        { path: '/lessons/marketing-analytics', labelKey: 'site.nav.week12' },
        { path: '/lessons/final-project', labelKey: 'site.nav.week13' },
        { path: '/lessons/presentation', labelKey: 'site.nav.week14' },
        { path: '/lessons/final-exam', labelKey: 'site.nav.week15' },
      ]
    },
    {
