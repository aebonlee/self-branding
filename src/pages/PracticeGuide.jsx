...
const PracticeGuide = () => {
  ...
  const practices = [
    ...
    { week: '5~7주차', title: '디지털 전략', icon: '📱', desc: 'SEO, SNS, 콘텐츠 마케팅 실습', tasks: ['키워드 리서치 실습', 'Instagram 콘텐츠 5개 기획', '콘텐츠 캘린더 작성'] },
    { week: '8주차', title: '중간고사', icon: '📝', desc: '1~7주차 종합 평가', tasks: ['주차별 핵심 개념 복습', '브랜드 전략 요약서 작성', '프레임워크 정리'], isExam: true },
    { week: '9~10주차', title: 'PR & 브랜딩 실전', icon: '📢', desc: '홍보 전략과 개인 브랜딩', tasks: ['보도자료 1건 작성', 'LinkedIn 프로필 최적화', '엘리베이터 피치 작성'] },
    { week: '11~12주차', title: '포트폴리오 & 분석', icon: '📂', desc: '포트폴리오 제작과 데이터 분석', tasks: ['포트폴리오 웹사이트 기획', 'GA4 대시보드 설정', '마케팅 KPI 보고서 작성'] },
    { week: '13~14주차', title: '프로젝트 & 발표', icon: '🎤', desc: '종합 프로젝트 완성 및 발표', tasks: ['브랜딩 프로젝트 기획서 작성', '최종 프로젝트 발표 준비', '동료 피드백 및 개선 계획'] },
    { week: '15주차', title: '기말고사', icon: '🏆', desc: '9~14주차 심화 과정 종합 평가', tasks: ['심화 과정 핵심 개념 복습', 'PR/포트폴리오/분석 프레임워크 정리', '종합 전략 보고서 작성'], isExam: true },
  ];
        ...
        <div className="container">
          <div className="lesson-body">
            ...
            <ul>
              ...
              <li>최종 프로젝트는 14주차에 발표 형식으로 진행</li>
            </ul>
