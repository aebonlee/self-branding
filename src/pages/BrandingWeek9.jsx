      ...
      <section className="lesson-content section" data-aos="fade-up">
        <div className="container">
          <div className="lesson-body">
            ...
            <h2>1. 온라인 프레즌스 구축</h2>
            <p>
              디지털 시대에 '검색되지 않으면 존재하지 않는 것'이라는 말이 있습니다.
            ...
            <table className="lesson-table">
              ...
              <tbody>
                <tr><td><strong>홈 (Home)</strong></td><td>핵심 메시지, 간략한 소개, CTA</td><td>5초 안에 "이 사람은 뭘 하는 사람인가"를 파악할 수 있어야 함</td></tr>
            ...
            <p>
              ...
              이를 '네임 SEO(Name SEO)' 또는 '퍼스널 SEO'라고 합니다.
            </p>
            <table className="lesson-table">
              <thead>
            ...
            <p>
              "당신이 아는 것보다 당신을 아는 사람이 더 중요하다(It's not what you know, it's who you know)"는
              네트워킹의 가치를 극단적으로 표현한 말입니다. 실제로는 "당신을 아는 사람이 당신에 대해
              무엇을 아는가(It's what who you know knows about you)"가 더 정확합니다.
            ...
            <table className="lesson-table">
              ...
              <tbody>
                ...
                <tr><td><strong>헤드라인</strong></td><td>"직함 | 전문 분야 | 핵심 가치" 형태</td><td>"단순 직함"이 아닌 가치 제안(Value Proposition) 포함</td></tr>
            ...
            <div className="callout-box">
              ...
              <ul>
                ...
                <li><strong>가치 교환</strong>: "무엇을 도와드릴 수 있을까요?"로 대화를 시작 (받기 전에 주기)</li>
                <li><strong>후속 조치</strong>: 행사 후 24시간 이내에 개인화된 메시지와 함께 LinkedIn 연결 요청</li>
                <li><strong>정기적 참석</strong>: 같은 커뮤니티에 3회 이상 참석하면 '아는 사람'에서 '신뢰하는 사람'으로 전환</li>
                <li><strong>발표자로 참여</strong>: 참석자에서 발표자로 역할을 전환하면 네트워킹 효과가 10배 증가</li>
                <li><strong>콘텐츠화</strong>: 행사에서 배운 내용을 LinkedIn 포스트나 블로그로 정리 공유 (행사 주최측에도 호의적)</li>
              </ul>
            </div>
            ...
            <p>
              ...
              청중 앞에서 자신의 전문 지식을 공유하면, 단순한 '전문가'에서 '사고 리더(Thought Leader)'로
            ...
            <div className="info-box tip">
              ...
              <p>
                ...
                핵심은 '나의 이야기'가 아니라 '관객이 가져갈 수 있는 아이디어'를 중심으로 기획하는 것입니다.
            ...
            <div className="callout-box">
              ...
              <p>
                'Building in Public'은 프로젝트의 진행 과정을 실시간으로 공개하는 트렌드입니다.
            ...
            <p>
              퍼스널 브랜딩에서 콘텐츠는 당신의 '자산'입니다. 한 번 만들어진 양질의 콘텐츠는
              ...
              <table className="lesson-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Hook → 상황 → 교훈 → CTA</td>
                    <td>"입사 첫날 대표님이 한 말", "면접에서 떨어진 후 깨달은 것"</td>
                    <td>800~1200자</td>
                  </tr>
                  <tr>
                    <td><strong>인사이트/팁</strong></td>
                    <td>문제 제기 → 해결책 리스트 → 요약</td>
                    <td>"마케터라면 알아야 할 5가지 지표", "리더십의 3가지 오해"</td>
                    <td>600~1000자</td>
                  </tr>
                  <tr>
                    <td><strong>의견/논평</strong></td>
                    <td>트렌드 언급 → 내 관점 → 근거 → 질문</td>
                    <td>"AI 시대에 마케터의 역할", "원격근무의 미래"</td>
                    <td>500~800자</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>맥락 제시 → 개방형 질문 → 내 의견 힌트</td>
                    <td>"여러분은 어떤 도구를 사용하시나요?", "이 트렌드 어떻게 생각하세요?"</td>
                    <td>300~500자</td>
                  </tr>
                </tbody>
              </table>
            ...
            <table className="lesson-table">
              ...
              <tbody>
                ...
                <tr><td><strong>구성</strong></td><td>인사 → 주제 → 실용 팁 → CTA → P.S.</td><td>친근하면서도 구조적인 형태</td></tr>
            ...
            <div className="info-box tip">
              ...
              <p>
                ...
                "OO님 말씀이 정말 흥미로운데, 좀 더 자세히 들려주실 수 있을까요?"처럼
            ...
            <div className="callout-box">
              ...
              <ul>
                ...
                <li><strong>명확한 포지셔닝</strong>: "OO 하면 OOO"라고 떠올려지는 명확한 포지션이 있다</li>
            ...
            <div className="exercise-box">
              ...
              <ul>
                <li>구글/네이버에 본인 이름 검색 → 상위 10개 결과 기록 및 평가</li>
