...
const BrandingWeek8 = () => {
  ...
  return (
    <>
      <SEOHead title="8주차: 기업 홍보 & PR" path="/lessons/corporate-pr" />
        ...
        <div className="container">
          <div className="lesson-body">
            ...
            <div className="info-box tip">
              <h3>PR과 광고는 본질적으로 다릅니다</h3>
              <p>
                광고는 돈을 내고 원하는 메시지를 원하는 시간에 노출하는 것이고,
                PR은 뉴스 가치를 통해 제3자(기자)가 자발적으로 보도하게 만드는 것입니다.
                광고의 신뢰도는 낮지만 통제력이 높고, PR의 신뢰도는 높지만 통제력은 낮습니다.
              </p>
            </div>
            ...
            <p>
              ...
              매일 수백 건의 보도자료를 받는 기자의 관심을 끌려면, 첫 문장에서 승부가 갈립니다.
            </p>
            ...
            <h3>역피라미드 구조</h3>
            <p>
              보도자료는 역피라미드(Inverted Pyramid) 구조로 작성합니다. 가장 중요한 정보를 먼저 배치하고,
              세부 사항을 뒤에 배치하여 기자가 기사의 분량에 맞게 뒤에서부터 잘라낼 수 있도록 합니다.
              신문 편집의 관행에서 비롯된 이 구조는 디지털 시대에도 여전히 유효하며,
              독자가 첫 문단만 읽어도 핵심 내용을 파악할 수 있어야 합니다.
            </p>

            <div className="info-box tip">
              <h3>보도자료 작성 체크리스트</h3>
              <ul>
                <li>헤드라인이 핵심 뉴스를 15자 내외로 명확히 전달하는가?</li>
                <li>리드 문단(첫 2~3문장)에 5W1H가 모두 포함되어 있는가?</li>
                <li>객관적 톤으로 작성되었는가? (광고 문구 배제)</li>
                <li>"최고", "혁신적" 같은 과장 형용사를 사용하지 않았는가?</li>
                <li>인용문이 자연스럽고, 핵심 메시지를 담고 있는가?</li>
                <li>보일러플레이트가 최신 정보로 업데이트되어 있는가?</li>
                <li>연락처가 정확하고, 담당자가 실제로 연락 가능한가?</li>
                <li>A4 기준 1~2페이지를 넘지 않는가?</li>
              </ul>
            </div>
            ...
            <div className="section-card" data-aos="fade-up">
              ...
              <div className="callout-box">
                ...
                <p><strong>즉시 배포 가능</strong></p>
                <br />
                <p><strong>제목:</strong> [회사명], [핵심 뉴스 한 줄 요약]</p>
                <p><strong>부제:</strong> [보충 설명 한 줄]</p>
                <br />
                <p><strong>[도시명, 날짜]</strong> — [회사명]이(가) [핵심 뉴스 내용]. [왜 중요한지 배경 설명]. [기대 효과나 의미].</p>
                <br />
                <p>[상세 내용 단락 1 — 제품/서비스 설명, 핵심 기능, 차별점]</p>
                <br />
                <p>[대표 또는 관계자 인용문] "[회사명] 대표 [이름]은(는) '인용 내용'이라고 말했다."</p>
                <br />
                <p>[추가 정보 — 출시일, 가격, 이용 방법 등]</p>
                <br />
                <p><strong>###</strong></p>
                <br />
                <p><strong>[회사 소개]</strong><br />[회사명]은(는) [설립연도]년에 설립된 [업종] 기업으로, [핵심 사업 설명]. 자세한 내용은 [웹사이트]를 방문하세요.</p>
                <br />
                <p><strong>[언론 문의]</strong><br />[담당자명] | [직함]<br />[전화번호] | [이메일]</p>
              </div>
            </div>
            ...
            <p>
              ...
              지속적인 신뢰 구축과 상호 가치 교환이 필요합니다. 기자에게 당신은 '보도자료를 보내는 사람'이
              아니라 '좋은 기사거리를 제공하는 신뢰할 수 있는 소스'가 되어야 합니다.
            </p>

            <h3>기자 관계 관리 전략</h3>
            <ul>
              <li><strong>타겟 미디어 리서치</strong>: 업종 관련 기자를 파악하고, 그들이 최근 쓴 기사 10개를 분석</li>
              <li><strong>가치 있는 정보 제공</strong>: 보도자료만 보내지 말고, 업계 독점 데이터나 전문가 인터뷰 기회 제공</li>
              <li><strong>관계 먼저, 요청은 나중에</strong>: 기사가 필요 없을 때도 커피 미팅, SNS 소통으로 관계 유지</li>
              <li><strong>빠른 응답</strong>: 기자의 문의에 1시간 이내 신속하고 정확하게 답변</li>
              <li><strong>존중과 이해</strong>: 기자의 마감 일정, 취재 스타일, 관심 분야 존중</li>
              <li><strong>독점 제공</strong>: 중요한 뉴스는 관계가 깊은 기자에게 독점(Exclusive)으로 먼저 제공</li>
            </ul>
            ...
            <div className="info-box tip">
              <h3>피칭(Pitching) 이메일 작성 팁</h3>
              <p>
                기자에게 보내는 피칭 이메일의 제목은 기사 헤드라인처럼 작성하세요.
                본문은 3문단 이내로 짧게, 핵심 뉴스 가치를 먼저 제시하고,
                "기사화해 주세요"가 아니라 "이 데이터가 기사에 도움이 될 것 같습니다"라고 접근합니다.
                기자의 최근 기사를 언급하며 왜 이 뉴스가 그 기자에게 적합한지 설명하면 효과적입니다.
                첨부파일은 가급적 피하고, 링크로 자료를 제공하세요.
              </p>
            </div>
            ...
            <p>
              ...
              사전에 위기관리 매뉴얼을 준비하고, 체계적인 대응 프로세스를 수립하는 것이 필수입니다.
            </p>
            ...
            <table className="lesson-table">
              ...
              <tbody>
                <tr><td><strong>제품/서비스 결함</strong></td><td>제품 리콜, 서비스 장애, 데이터 유출, 안전 사고</td><td>높음</td><td>2시간 이내</td></tr>
                <tr><td><strong>경영진 이슈</strong></td><td>CEO 스캔들, 경영 비리, 갑질 논란, 횡령</td><td>높음</td><td>4시간 이내</td></tr>
                ...
                <tr><td><strong>외부 환경</strong></td><td>자연재해, 팬데믹, 규제 변경, 경기 침체</td><td>중간</td><td>상황에 따라</td></tr>
                <tr><td><strong>경쟁사 관련</strong></td><td>비교 광고 논란, 특허 분쟁, 인력 유출</td><td>중간</td><td>24시간 이내</td></tr>
              </tbody>
            </table>
              ...
              <table className="lesson-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>이슈 모니터링, 초기 징후 포착, 심각도 평가, 경영진 보고</td>
                    <td>실시간 모니터링</td>
                    <td>PR팀 / 모니터링 도구</td>
                  </tr>
                  <tr>
                    <td><strong>2. 분석 (Analysis)</strong></td>
                    <td>사실 확인(Fact-checking), 영향 범위 파악, 이해관계자 매핑, 시나리오 수립</td>
                    <td>1~4시간 이내</td>
                    <td>위기관리 TF</td>
                  </tr>
                  <tr>
                    <td><strong>3. 대응 (Response)</strong></td>
                    <td>공식 입장 발표, 기자회견, SNS 대응, 피해 보상, 내부 커뮤니케이션</td>
                    <td>24시간 이내</td>
                    <td>대표 / PR팀 / 법무</td>
                  </tr>
                  <tr>
                    <td><strong>4. 회복 (Recovery)</strong></td>
                    <td>이미지 회복 캠페인, 재발 방지책 공표, 사후 분석(Post-mortem), 제도 개선</td>
                    <td>1~6개월</td>
                    <td>전사적 협력</td>
                  </tr>
                </tbody>
            ...
            <div className="info-box warning">
              ...
              <ul>
                ...
                <li><strong>법적 용어 남용</strong>: 변호사가 쓴 듯한 딱딱한 문장은 진정성을 떨어뜨립니다.</li>
              </ul>
            </div>
            ...
            <p>
              ...
              사회와 환경에 대한 책임을 이행하는 활동입니다. 최근에는 ESG(Environment, Social, Governance)
              경영이 투자 판단과 소비자 선택의 핵심 기준이 되고 있으며,
              MZ세대 소비자의 73%는 "사회적 가치를 실천하는 브랜드를 더 선호한다"고 응답했습니다.
            </p>
            ...
            <table className="lesson-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>탄소 중립 선언, 친환경 패키징, 재생 에너지 전환</td>
                  <td>탄소 배출량, 재활용률, 에너지 효율</td>
                </tr>
                <tr>
                  <td><strong>S (사회)</strong></td>
                  <td>인권, 다양성, 지역사회 공헌, 노동 환경</td>
                  <td>공정 거래, 다양성 채용, 지역 봉사 활동, 교육 지원</td>
                  <td>다양성 비율, 산업재해율, 기부금</td>
                </tr>
                <tr>
                  <td><strong>G (거버넌스)</strong></td>
                  <td>이사회 구조, 윤리 경영, 투명성, 주주 권리</td>
                  <td>독립 이사 선임, 반부패 정책, 정보 공개, 내부 고발 제도</td>
                  <td>독립이사 비율, 감사 결과, 윤리 교육 이수율</td>
                </tr>
              </tbody>
            </table>
            ...
            <div className="info-box tip">
              <h3>개인 브랜딩에서의 CSR</h3>
              <p>
                기업뿐 아니라 개인 브랜드도 사회적 책임을 실천할 수 있습니다.
                재능 기부, 무료 멘토링, 사회적 이슈에 대한 의견 표명, 친환경 라이프스타일 공유,
                소외 계층 지원 활동 등을 통해 브랜드의 가치관과 진정성을 보여줄 수 있습니다.
                중요한 것은 일회성 이벤트가 아니라 자신의 전문성과 연결된 지속적인 활동이어야 한다는 점입니다.
              </p>
            </div>
            ...
            <p>
              ...
              미디어 노출을 확보할 수 있는 효과적인 PR 도구입니다. 성공적인 이벤트 PR은
              행사 전-중-후 3단계에 걸쳐 체계적으로 계획되어야 합니다.
            </p>
            ...
            <table className="lesson-table">
              ...
              <tbody>
                ...
                <tr><td><strong>D-Day</strong></td><td>현장 운영</td><td>기자 등록 데스크, 보도자료 키트 배포, 현장 SNS 업데이트</td></tr>
                <tr><td><strong>D+1</strong></td><td>사후 보도자료</td><td>행사 결과 보도자료, 사진/영상 배포</td></tr>
                <tr><td><strong>D+3</strong></td><td>감사 메일</td><td>참석자 감사 이메일, 사후 설문, 미디어 클리핑</td></tr>
                <tr><td><strong>D+7</strong></td><td>후속 콘텐츠</td><td>행사 하이라이트 영상, 블로그 포스트, 인터뷰 기사</td></tr>
              </tbody>
            </table>

            <div className="callout-box">
              <h4>기자 키트(Press Kit) 구성</h4>
              <ul>
                <li>보도자료 (인쇄본 + USB 또는 QR코드로 디지털 버전)</li>
                <li>회사/브랜드 팩트시트 (핵심 수치, 연혁, 주요 실적)</li>
                <li>고해상도 이미지 (제품, 행사장, 경영진 사진)</li>
                <li>인포그래픽 또는 데이터 자료</li>
                <li>경영진/발표자 약력</li>
                <li>FAQ 문서</li>
                <li>기념품 (브랜디드 아이템)</li>
              </ul>
            ...
            <p>
              ...
              뉴스와이어(Newswire) 서비스, 기업 뉴스룸, 블로그 PR, 소셜 미디어 PR 등
              온라인 채널을 적극 활용해야 합니다. 온라인 PR은 비용 효율적이고,
              타겟팅이 정밀하며, 효과 측정이 용이하다는 장점이 있습니다.
            </p>
            ...
            <table className="lesson-table">
              ...
              <tbody>
                ...
                <tr><td><strong>온라인 커뮤니티</strong></td><td>타겟 고객이 모인 커뮤니티</td><td>전문성 기반 참여, 자연스러운 브랜드 노출</td><td>무료~저비용</td></tr>
              </tbody>
            </table>
            ...
            <div className="info-box tip">
              <h3>온라인 PR 핵심 지표</h3>
              <p>
                온라인 PR의 효과를 측정할 때는 다음 지표를 추적하세요:
                기사 게재 건수, 기사 도달 범위(Reach), 소셜 미디어 언급량(Mentions),
                감성 분석(Sentiment Analysis), 웹사이트 유입 트래픽, 검색량 변화(Brand Search Volume),
                Share of Voice(SOV) 등을 종합적으로 분석해야 합니다.
              </p>
            </div>
            ...
            <p>
              ...
              내부 소통이 원활하지 않으면 외부 커뮤니케이션의 일관성도 무너지며,
              직원의 불만이 외부로 유출되면 심각한 위기 상황을 초래할 수 있습니다.
            </p>

            <h3>내부 커뮤니케이션 채널</h3>
            <table className="lesson-table">
              <thead>
                <tr><th>채널</th><th>용도</th><th>빈도</th><th>효과</th></tr>
              </thead>
              <tbody>
                <tr><td><strong>사내 뉴스레터</strong></td><td>주요 소식, 성과 공유, 직원 인터뷰</td><td>주간/격주</td><td>정보 전달, 소속감</td></tr>
                <tr><td><strong>인트라넷</strong></td><td>문서 공유, 공지사항, 사내 게시판</td><td>상시</td><td>정보 접근성</td></tr>
                <tr><td><strong>타운홀 미팅</strong></td><td>경영진과 전 직원 대화, Q&amp;A</td><td>월간/분기</td><td>투명성, 신뢰</td></tr>
                <tr><td><strong>Slack/Teams</strong></td><td>실시간 소통, 프로젝트 협업</td><td>상시</td><td>협업 효율</td></tr>
                <tr><td><strong>직원 앰배서더 프로그램</strong></td><td>직원이 자발적으로 브랜드 홍보</td><td>상시</td><td>진정성 있는 외부 홍보</td></tr>
              </tbody>
            </table>
            ...
            <div className="exercise-box">
              ...
              <p><strong>추가 과제:</strong> 이 보도자료를 발송할 미디어 리스트(최소 5개 매체)를 작성하고, 각 매체별 피칭 포인트를 1줄씩 작성하세요.</p>
            </div>
            ...
            <div className="exercise-box">
              ...
              <ul>
                ...
                <li>공식 사과문/성명서 초안 (5대 요소 모두 포함, 400자 내외)</li>
                <li>SNS 대응 멘트 3가지 버전 (트위터용, 인스타그램용, 블로그용)</li>
              </ul>
            </div>

            <div className="exercise-box">
              <h3>과제 C: CSR 활동 기획서</h3>
              <p>나의 브랜드(개인 또는 기업)에 맞는 CSR/ESG 활동 1가지를 기획하세요:</p>
              <ul>
                <li>활동명 및 목적</li>
                <li>타겟 수혜자 (누구를 위한 활동인가)</li>
                <li>구체적 실행 계획 (일정, 방법, 필요 자원)</li>
                <li>PR 연계 방안 (보도자료, SNS 콘텐츠, 미디어 초청 계획)</li>
                <li>기대 효과 및 측정 지표</li>
              </ul>
            </div>
            ...
            <div className="info-box tip">
              <h3>다음 주 예고</h3>
              <p>
                9주차에서는 개인 브랜딩 실전에 들어갑니다. 온라인 프레즌스 구축부터 LinkedIn 최적화,
            ...
            <div className="lesson-nav">
              ...
              <Link to="/lessons/personal-branding" className="lesson-nav-btn next">9주차: 개인 브랜딩 실전 &rarr;</Link>
            </div>
          </div>
        </div>
      </section>
