...
export default function About(): ReactElement {
  return (
    <>
      <SEOHead title="About | Self-Branding" description="기업홍보부터 개인브랜딩까지 - 셀프 브랜딩 마케팅 종합 학습" />
        ...
        <div className="container">
          ...
          <div style={{
            ...
            <strong style={{ fontSize: '17px', display: 'block', marginBottom: '12px' }}>
              이 사이트는 기업홍보부터 개인브랜딩까지 셀프 브랜딩 마케팅을 학습하는 플랫폼입니다.
            </strong>
            <p style={{ margin: 0 }}>
              드림아이티비즈(DreamIT Biz)는 기업과 개인의 실제 니즈를 반영한 맞춤형 교육 플랫폼을 제작합니다.
              디지털 시대의 효과적인 셀프 브랜딩 전략과 마케팅 기법을 종합적으로 다룹니다.
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginBottom: '48px' }}>
            {[
              { icon: 'fa-user-tie', title: '개인 브랜딩', desc: '나만의 브랜드를 구축하는 전략을 학습합니다.' },
              { icon: 'fa-bullhorn', title: '마케팅 전략', desc: 'SNS, 콘텐츠 마케팅 등 디지털 마케팅을 배웁니다.' },
              { icon: 'fa-building', title: '기업 홍보', desc: '효과적인 기업 PR과 홍보 전략을 다룹니다.' },
              { icon: 'fa-camera', title: '콘텐츠 제작', desc: '브랜딩을 위한 콘텐츠 기획·제작 방법을 학습합니다.' },
            ].map((item, i) => (
              <div key={i} style={{
                display: 'flex',
                gap: '16px',
